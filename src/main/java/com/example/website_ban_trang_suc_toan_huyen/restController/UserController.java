...
public class UserController {
    ...
    public ResponseEntity<?> updatePass(@PathVariable("id") UUID id, @Validated @RequestBody UserRequest userRequest){
        return ResponseEntity.ok(SampleResponse.success(this.userService.changPass(id,userRequest)));
    }
